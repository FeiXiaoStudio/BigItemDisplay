...
public class BigItemDisplayItems {
    public static final Item BIG_ITEM_DISPLAY = register(
            "big_item_display",
            new BigItemDisplayItem(BigItemDisplayEntityType.BIG_ITEM_DISPLAY, new Item.Settings())
    );
    ...
    public static void initialize() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FUNCTIONAL).register(
            itemGroup -> itemGroup.addAfter(Items.GLOW_ITEM_FRAME, BIG_ITEM_DISPLAY)
        );
    }
